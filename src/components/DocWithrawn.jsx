...
export default function DocWithdrawn() {
  return (
    <div className="bg-blue-100 min-h-screen p-3">
      <h1 className="text-xl font-semibold">List of Withdrawn Documents</h1>
        ...
        <table className="w-full text-sm font-medium text-left rtl:text-right">
          <thead className="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-white">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 w-1/6">Document No.</th>
              {/* <th scope="col" className="px-6 py-3 w-1/6">Index </th> */}
