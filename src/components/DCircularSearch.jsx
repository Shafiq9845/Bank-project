  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold text-gray-800 mb-6">Search Circulars</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700">Circular Object</label>
            <input
              type="text"
              name="circularObject"
              value={formData.circularObject}
              onChange={handleChange}
              placeholder="Enter circular object"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
