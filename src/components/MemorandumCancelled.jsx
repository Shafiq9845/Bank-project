        ...
        <table className="w-full text-sm font-medium text-left rtl:text-right">
          <thead className="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-white">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 w-1/6">Memo No.</th>
              <th scope="col" className="px-6 py-3 w-1/6">Index No.</th>
              <th scope="col" className="px-6 py-3 w-1/2">Reason</th>
            </tr>
          </thead>
          <tbody>
            <tr className="bg-white border-b">
              ...
              <td className="px-6 py-4">116/2005</td>
            ...
            <tr className="bg-white border-b">
              ...
              <td className="px-6 py-4">350/2006</td>
            ...
            <tr className="bg-white">
              ...
              <td className="px-6 py-4">92/2012</td>
              <td className="px-6 py-4">IDX-7890</td>
              <td className="px-6 py-4">This is a test Memo</td>
            </tr>
            <tr className="bg-white">
              <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                2024-12-23
              </th>
              <td className="px-6 py-4">108/2016</td>
              <td className="px-6 py-4">IDX-7887</td>
              <td className="px-6 py-4">Dummi Data</td>
            </tr>
          </tbody>
        </table>
      </div>
